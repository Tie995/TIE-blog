...
{{< image src="/img/post/20190407/1.png">}}
...
{{< image src="/img/post/20190407/2.png">}}

打开后的软件长这样：

{{< image src="/img/post/20190407/3.png">}}

（2）【File】-【Open】，打开文件后得下图。

{{< image src="/img/post/20190407/4.png">}}
...
{{< image src="/img/post/20190407/5.png">}}

（4）将变量选入右侧。选中结果变量，点击【Set】；选中自变量，点击【Add】。

注：下方勾选框勾不勾选都可以，只是方便查看，不影响结果，建议勾选。

{{< image src="/img/post/20190407/6.png">}}

注：求使结果不发生的简约条件时，选中结果变量，点击【Set Negated】，得下图。

{{< image src="/img/post/20190407/7.png">}}

（5）点击【OK】，得下图。

{{< image src="/img/post/20190407/8.png">}}

（6）【Edit】-【Delete and code】

{{< image src="/img/post/20190407/9.png">}}
...
{{< image src="/img/post/20190407/14.png">}}
...
{{< image src="/img/post/20190407/15.png">}}
...
{{< image src="/img/post/20190407/16.png">}}

③点击【确定】，对新建的数据文件命名并确定储存位置。

{{< image src="/img/post/20190407/17.png">}}

④点击【确定】，导入成功后如下图所示。

{{< image src="/img/post/20190407/18.png">}}

（3）【csQCA/mvQCA】-【Start csQCA/mvQCA】

{{< image src="/img/post/20190407/19.png">}}
...
{{< image src="/img/post/20190407/20.png">}}

## **二、结果解读**

（1）点击【just】，可得求解结果。

{{< image src="/img/post/20190407/21.png">}}

（2）点击【full】，可得完整结果。注：软件会以网页形式弹出完整结果。

{{< image src="/img/post/20190407/22.png">}}
...
{{< image src="/img/post/20190407/23.png">}}
...
{{< image src="/img/post/20190407/24.png">}}

（3）选定上文求出的条件与结果。

注：此处条件可按【Ctrl】多选。

{{< image src="/img/post/20190407/25.png">}}
