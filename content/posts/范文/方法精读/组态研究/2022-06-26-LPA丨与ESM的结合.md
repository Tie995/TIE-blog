...
{{< image src="/img/post/20220626/1.png">}}

{{< image src="/img/post/20220626/2.png">}}

## **检验RQ1a**

第一步，作者首先在MLPA中分别对WIF和FIW归因分别进行剖面建模，并逐渐增加提取的剖面的数量，直到模型拟合不再改进，或存在模型收敛问题；每个剖面解的拟合指标结果如表3所示。

{{< image src="/img/post/20220626/3.png">}}
...
{{< image src="/img/post/20220626/4.png">}}
...
{{< image src="/img/post/20220626/5.png">}}
